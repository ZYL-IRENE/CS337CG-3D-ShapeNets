...
% data path
param.off_path = './off';
param.data_path = './volumetric_data_90';
...
save('./model/90/model30_l2','model');
...
save('./model/90/model30_l3','model');
...
param.sparse_cost = 0;
[model] = crbm(model, data_list, param);
save('./model/90/model30_l4','model');

load './model/90/model30_l4';
...
save('./model/90/model30_l5','model');
...
save('./model/90/pretrained_model','model');
