...
% data path
param.off_path = './off';
param.data_path = './volumetric_data_360';
...
%write_input_data(param.off_path, param.data_path, param.classnames, param.volume_size, param.pad_size, 360);
...
% save('./model/360/model30_l2','model');
...
% save('./model/360/model30_l3','model');
% 
% param = [];
% param.layer = 4;
% param.epochs = 50;
...
% param.sparse_cost = 0;
% [model] = crbm(model, data_list, param);
% save('./model/360/model30_l4','model');

load './model/360/model30_l4';
[hidden_prob_h4, train_label] = propagate_data(model, data_list, 5);
save('./model/360/train_label','train_label');
save('./model/360/hidden_prob_h4','hidden_prob_h4');
fprintf('saved train_label \n');
...
save('./model/360/model30_l5','model');
save('./model/360/hidden_prob_h5','hidden_prob_h5');
fprintf('saved hidden h5\n');
...
save('./model/360/pretrained_model','model');
